...
export const alt = 'Портфолио работ Siblay — примеры 3D-печати и моделирования'
    ...
    (
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
          ...
          >
            Функциональные детали, художественные изделия, архитектурные макеты. PLA, PETG, TPU.
          </div>
        </div>
        ...
        >
          <span>siblay.ru/portfolio</span>
          <span>Каждая деталь · вручную</span>
        </div>
      </div>
    ),
    { ...size }

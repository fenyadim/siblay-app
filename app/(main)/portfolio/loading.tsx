    ...
    <div className="min-h-screen bg-background py-12 pb-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-10">
          ...
          <div className="h-10 w-48 rounded-lg bg-border animate-pulse mb-3" />
          <div className="h-4 w-80 rounded bg-border animate-pulse" />
        </div>

        {/* Filter skeleton */}
        <div className="flex gap-2 mb-8 flex-wrap">
          {Array.from({ length: 6 }).map((_, i) => (
            <div key={i} className="h-8 w-24 rounded-full bg-border animate-pulse" />
          ))}
        </div>

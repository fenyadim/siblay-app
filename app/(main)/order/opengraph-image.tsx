...
export const alt = 'Оформить заказ на 3D-печать — Siblay'
    ...
    (
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
          ...
          >
            Загрузите модель или фото, выберите материал и цвет — стоимость рассчитается автоматически.
          </div>
        </div>
        ...
        >
          <span>siblay.ru/order</span>
          <span>STL · OBJ · 3MF · STEP</span>
        </div>
      </div>
    ),
    { ...size }

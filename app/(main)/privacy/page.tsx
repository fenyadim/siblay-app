        ...
        <div className="space-y-8 text-sm leading-7 text-foreground">
          <section className="space-y-3">
            ...
            <p>
              ...
              меры по обеспечению безопасности персональных данных, предпринимаемые Орлов Дмитрий
          ...
          <section className="space-y-3">
            ...
            <p>
              ...
              определенному или определяемому Пользователю веб-сайта https://siblay.ru.
            </p>
            <p>
            ...
            <p>2.10. Пользователь — любой посетитель веб-сайта https://siblay.ru.</p>
            <p>
            ...
            <div className="border border-border rounded-xl overflow-hidden">
              <dl className="divide-y divide-border">
                <div className="grid grid-cols-1 sm:grid-cols-[200px_1fr]">
                  <dt className="bg-surface px-4 py-3 font-semibold">Цель обработки</dt>
                  <dd className="px-4 py-3">уточнение деталей заказа</dd>
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-[200px_1fr]">
                  <dt className="bg-surface px-4 py-3 font-semibold">Персональные данные</dt>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-[200px_1fr]">
                  <dt className="bg-surface px-4 py-3 font-semibold">Правовые основания</dt>
                  <dd className="px-4 py-3">
                    <ul className="list-disc pl-5 space-y-1">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-[200px_1fr]">
                  <dt className="bg-surface px-4 py-3 font-semibold">
          ...
          <section className="space-y-3">
            ...
            <p>
              ...
              электронной почты Оператора privacy@siblay.ru с пометкой «Актуализация персональных
              данных».
            </p>
            <p>
            ...
            <p>
              ...
              адрес Оператора privacy@siblay.ru с пометкой «Отзыв согласия на обработку персональных
              данных».
            </p>
            <p>
          ...
          <section className="space-y-3">
            ...
            <p>
              ...
              Толстого, д. 16. Цели обработки: анализ поведения пользователей, оценка
              эффективности Сайта, запись действий пользователя в форме заказа.
            </p>
            <p>
              9.2. Сервис автоматически собирает следующие данные: IP-адрес, тип устройства,
              версия браузера, источник перехода, посещённые страницы, действия на сайте.
            </p>
            <p>
          ...
          <section className="space-y-3">
            ...
            <p>
              10.1. Оператор осуществляет сбор, запись, систематизацию, накопление, хранение, уточнение
            ...
            <p>
              10.2. Оператор осуществляет автоматизированную обработку персональных данных с получением
          ...
          <section className="space-y-3">
            ...
            <p>
              11.1. Оператор до начала осуществления деятельности по трансграничной передаче
            ...
            <p>
              11.2. Оператор до подачи вышеуказанного уведомления, обязан получить от органов власти
          ...
          <section className="space-y-3">
            ...
            <p>
              13.1. Пользователь может получить любые разъяснения по интересующим вопросам, касающимся
              обработки его персональных данных, обратившись к Оператору с помощью электронной почты
              privacy@siblay.ru.
            </p>
            <p>
              13.2. В данном документе будут отражены любые изменения политики обработки персональных
              данных Оператором. Политика действует бессрочно до замены ее новой версией.
            </p>
            <p>
              13.3. Актуальная версия Политики в свободном доступе расположена в сети Интернет по
              адресу https://siblay.ru/privacy.
            </p>
          </section>
        </div>
      </div>

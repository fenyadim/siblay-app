        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center gap-2.5 mb-4">
              ...
              <span className="font-display font-bold text-foreground" style={{ fontFamily: "Syne, sans-serif" }}>
                Siblay
              </span>
            </div>
            ...
            <div className="flex gap-3 mt-4">
              <a href="#" aria-label="Telegram" className="w-8 h-8 rounded-lg border border-border flex items-center justify-center text-muted hover:text-accent hover:border-(--accent-border) transition-colors">
                <svg width="14" height="14" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm5.562 8.248-1.97 9.289c-.145.658-.537.818-1.084.508l-3-2.21-1.447 1.394c-.16.16-.295.295-.605.295l.213-3.053 5.56-5.023c.242-.213-.054-.333-.373-.12l-6.871 4.326-2.962-.924c-.643-.204-.657-.643.136-.953l11.57-4.461c.537-.194 1.006.131.833.932z" />
                </svg>
              </a>
              <a href="#" aria-label="VK" className="w-8 h-8 rounded-lg border border-border flex items-center justify-center text-muted hover:text-accent hover:border-(--accent-border) transition-colors">
                <svg width="14" height="14" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {["3D-моделирование", "3D-печать FDM", "3D-печать SLA", "Постобработка", "Серийное производство"].map((s) => (
                <li key={s}>
                  <Link href="/order" className="text-sm text-muted hover:text-accent transition-colors">
                    {s}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-2 text-sm text-muted">
                <svg className="mt-0.5 shrink-0 text-accent" width="14" height="14" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
